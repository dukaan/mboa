...
<section id="navBar">
	...
	<?php }?>
	<!--Only for HeaderV6-->
	<nav class="mboa-navigation sticky-container <?php echo $navBlack; ?> <?php echo $navFull; ?> <?php echo $navFullv2;?> <?php  echo $navfullv2light; ?>" data-sticky-container>
		<div class="topnav" data-top-anchor="navBar" data-btm-anchor="footer-bottom:bottom" data-margin-top="0" data-margin-bottom="0" style="width: 100%; background: <?php echo $background; ?>;" data-sticky-on="large">
					...
					<div class="newsTicker">
						...
						<?php 
							if(empty($beTubeNewsCats)){
								...
								$args = array( 'posts_per_page' => $beTubeNewsCount, 'order'=> 'ASC', 'orderby' => $beTubeNewsSortOrder, 'category__in'=> $beTubeNewsCats);
							}
			...
			<div id="betube-bar" class="clearfix search-bar-light <?php echo $searchbardark; ?>">
				<form role="search" method="get" class="search-form" action="<?php echo home_url( '/' ); ?>">
					...
					<div class="search-btn float-right text-right">						
						<button class="button" type="submit"><?php esc_html_e( 'Search Now', 'betube' ); ?></button>						
					</div>
				</form>
			</div>
		<?php }?>
