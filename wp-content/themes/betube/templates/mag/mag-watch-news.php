			...
			<div class="Media Media--reverse borderBottom">
				...
				<div class="Media-body">
					<div class="betube_mag__heading">
						<div class="betube_mag__heading_icon" style="background:<?php echo $betubeWatchNewsIconColor; ?>;">
							<i class="<?php echo $betubeWatchNewsIcon; ?>"></i>
						</div><!--betube_mag__heading_icon-->
						<div class="betube_mag__heading_head">
							<h3><?php echo $betubeWatchNewsTitle; ?></h3>
							<p><?php echo $betubeWatchNewsDesc; ?></p>
