...
?>
<div class="row expanded right-left-sidebar">
	<div class="large-6 large-push-3 responsive-top columns">
		<?php
			/*First Section*/
			if($betubeFirstSecON == 1){
				...
				beTubeTwoSidebarHome($sectionTitle, $sectionCategory, $sectionView, $sectionCount, $sectionOrder, $sectionAdsCode);
			}
			/*Second Section*/
	...
	<div class="large-3 large-pull-6 responsive-bottom columns">
	...
	<div class="large-3 small-12 small-push-12 columns">
		<aside class="secBg sidebar">
			<div class="row">
