...
class Betube_Recent_Videos extends WP_Widget {
			...
			<div class="media-object-section">
				<div class="media-content">
					...
					<p>
						...
						<span><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo get_the_author_meta('display_name'); ?></a></span>
						<?php if ( $show_date ) : ?>
